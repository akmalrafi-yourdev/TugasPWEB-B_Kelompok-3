...
app.post("/dosen/nilai/tambah", (req, res) => {
  let pesan = {
    ...
    Komponen: ["1. Tugas =  15%", "2. Kehadiran = 5%", "3. UTS = 35%", "4. UAS = 45%"],
  };
  res.json(pesan);
...
app.put("/dosen/nilai/edit", (req, res) => {
  let pesan = {
    ...
    Kode: "JSI62125",
    Nama: "Pemrograman Web",
    Komponen: ["1. Tugas =  15%", "2. Kehadiran = 5%", "3. Keaktifan = 5%", "3. UTS = 35%", "4. UAS = 40%"],
  };
  res.json(pesan);
...
app.delete("/dosen/nilai/hapus", (req, res) => {
  let pesan = {
    ...
    Kode: "JSI62125",
    Nama: "Pemrograman Web",
    Komponen: ["1. Tugas =  15%", "3. Keaktifan = 10%", "3. UTS = 35%", "4. UAS = 40%"],
  };
  res.json(pesan);
